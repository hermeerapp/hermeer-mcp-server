...
10. SUNDAY FALLBACK: Check what day of the week it is. If today is Sunday AND no weekly synthesis exists for this week (check $HermeerBase\depth\synthesis\ for a file covering this week), do the Sunday weekly work that morning missed:
...
12. SAVE THE BRIEFING: Write the full evening reading to $BriefingDir\$today-evening.md. Frontmatter:
---
date: $today
command: evening
tags: [briefing, daily]
