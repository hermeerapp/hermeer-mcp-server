...
2. Read ALL entries from the past 7 days — every tarot pull, dream, journal entry, session, and synchronicity in $HERMEER_BASE/tarot/, dreams/, journal/, sessions/, synchronicities/
3. Read any existing interpretations for this week's entries from $HERMEER_BASE/depth/
4. Read the previous weekly reflection(s) from $DEPTH_PROJECT/learnings/weekly-reflections.md if it exists — know the format and the arc
5. Read today's transit watch if it exists: $DEPTH_PROJECT/logs/transit-watch-today.md
...
7. Write the reflection to $DEPTH_PROJECT/learnings/weekly-reflections.md (append with ## header for the week)
...
14. SAVE THE BRIEFING: Write the full field reading to $BRIEFING_DIR/\$(date +%Y-%m-%d)-sunday.md. Frontmatter:
---
date: [today]
command: sunday
